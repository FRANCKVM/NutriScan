          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-indigo-900">
              {activeConditions.length === 0
                ? 'Ningun filtro activo (analisis general)'
        ...
        {activeConditions.length === 0 && (
          <div className="mt-4 p-3.5 bg-yellow-50/70 border border-yellow-100 rounded-xl flex gap-2.5">
            ...
            <p className="text-xs text-yellow-800 leading-snug">
              <strong>Nota:</strong> Al no tener filtros de salud activos, el escaner analizara los productos de acuerdo a las pautas generales de alimentacion, sin emitir advertencias de peligro personalizadas.
            </p>
          </div>
        )}
      </div>
